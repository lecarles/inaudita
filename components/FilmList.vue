  ...
  <div>
    <div class="film-list text-lg text-center uppercase leading-[0.8]">
      <nuxt-link v-for="film in films.data.stories" :key="film._uid" class="film-item" :to="`/films/${film.slug}`">
        ...
        <div class="film-item-data-title text-2xl leading-[0.8] text-balance">{{ film.content.title}}</div>
    ...
    <div class="py-(--xl) text-lg w-full uppercase text-center">
      ...
      <div class="flex justify-center gap-(--sm)"><a href="mailto:info@inauditafilms.com">info@inauditafilms.com</a></div>
    </div>
  </div>
</template>
